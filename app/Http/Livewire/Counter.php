 ...
 protected $listeners = [
   ...
   /* public function getCommune($code){
    ...
    public function render()
    {
        ...
        ->orderBy('count','desc')
        ->get(),'withwebsite'=>RentAgency::whereNotNull('website')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withrating'=>RentAgency::whereNotNull('rating')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('title','like', '%'.trim($this->search).'%')
        ->count()
        ,'total'=>RentAgency::where('title','like', '%'.trim($this->search).'%')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
        ->limit(1)->get()]);
        ...
        ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>RentAgency::where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('rating')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
        ->limit(1)->get()]);
                        }
                        else if ($this->website!=false && $this->rating==false && $this->phone!=false && $this->ouvert==false){
                            return view('livewire.counter', [
        ...
        ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>RentAgency::where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('phone')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
        ->limit(1)->get()]);
                            }
                            else if ($this->website!=false && $this->rating==false && $this->phone==false && $this->ouvert!=false){
                                return view('livewire.counter', [
        ...
        ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>RentAgency::where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
        ->limit(1)->get()]);
                                }
                            else if ($this->website==false && $this->rating!=false && $this->phone!=false && $this->ouvert==false){
                                return view('livewire.counter', [
        ...
        ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>RentAgency::where('title','like', '%'.trim($this->search).'%')->whereNotNull('rating')->whereNotNull('phone')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
        ->limit(1)->get()]);
                                }
                                else if ($this->website==false && $this->rating!=false && $this->phone==false && $this->ouvert!=false){
                                    return view('livewire.counter', [
        ...
        ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>RentAgency::where('title','like', '%'.trim($this->search).'%')->whereNotNull('rating')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
        ->limit(1)->get()]);
                                    }
                                    else if ($this->website==false && $this->rating==false && $this->phone!=false && $this->ouvert!=false){
                                        return view('livewire.counter', [
        ...
        ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>RentAgency::where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('rating')->whereNotNull('phone')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
        ->limit(1)->get()]);
                                            }
                                            else if ($this->website!=false && $this->rating!=false && $this->phone==false && $this->ouvert!=false){
                                                return view('livewire.counter', [
        ...
        ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>RentAgency::where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('rating')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
        ->limit(1)->get()]);
                                                }
                                                else if ($this->website==false && $this->rating!=false && $this->phone!=false && $this->ouvert!=false){
                                                    return view('livewire.counter', [
        ...
        ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>RentAgency::where('title','like', '%'.trim($this->search).'%')->whereNotNull('rating')->whereNotNull('phone')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
        ->limit(1)->get()]);
                                                    }
                                                    else if ($this->website!=false && $this->rating==false && $this->phone!=false && $this->ouvert!=false){
                                                        return view('livewire.counter', [
        ...
        ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>RentAgency::where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('phone')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
        ->limit(1)->get()]);
                                                        }
            else{
                return view('livewire.counter', [
        ...
        ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>RentAgency::where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('rating')->whereNotNull('phone')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
        ->limit(1)->get()]);
                } 
        ...
        if($this->selectedCommune!=null){
            if($this->website==false && $this->rating==false && $this->phone==false && $this->ouvert==false){
                ...
                ->whereNotNull('rating')->groupBy('rate')
                ->orderBy('count','desc')
                ->get(),'withwebsite'=>RentAgency::whereNotNull('website')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search))
                ->count(),'withrating'=>RentAgency::whereNotNull('rating')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',$this->selectedCommune)
                ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
                ->limit(1)->get()
               ]);
                ...
                ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',$this->selectedCommune)
                ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('rating')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
                ->limit(1)->get()]);
                                }
                                else if ($this->website!=false && $this->rating==false && $this->phone!=false && $this->ouvert==false){
                                    return view('livewire.counter', [
                ...
                ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',$this->selectedCommune)
                ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('phone')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
                ->limit(1)->get()]);
                                    }
                                    else if ($this->website!=false && $this->rating==false && $this->phone==false && $this->ouvert!=false){
                                        return view('livewire.counter', [
                ...
                ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',$this->selectedCommune)
                ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
                ->limit(1)->get()]);
                                        }
                                    else if ($this->website==false && $this->rating!=false && $this->phone!=false && $this->ouvert==false){
                                        return view('livewire.counter', [
                ...
                ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',$this->selectedCommune)
                ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')->whereNotNull('rating')->whereNotNull('phone')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
                ->limit(1)->get()]);
                                        }
                                        else if ($this->website==false && $this->rating!=false && $this->phone==false && $this->ouvert!=false){
                                            return view('livewire.counter', [
                ...
                ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',$this->selectedCommune)
                ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')->whereNotNull('rating')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
                ->limit(1)->get()]);
                                            }
                                            else if ($this->website==false && $this->rating==false && $this->phone!=false && $this->ouvert!=false){
                                                return view('livewire.counter', [
                ...
                ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',$this->selectedCommune)
                ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')->whereNotNull('phone')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
                ->limit(1)->get()]);
                                                }
                                                else if ($this->website!=false && $this->rating!=false && $this->phone!=false && $this->ouvert==false){
                                                    return view('livewire.counter', [
                ...
                ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',$this->selectedCommune)
                ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('rating')->whereNotNull('phone')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
                ->limit(1)->get()]);
                                                    }
                                                    else if ($this->website!=false && $this->rating!=false && $this->phone==false && $this->ouvert!=false){
                                                        return view('livewire.counter', [
                ...
                ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',$this->selectedCommune)
                ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('rating')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
                ->limit(1)->get()]);
                                                        }
                                                        else if ($this->website==false && $this->rating!=false && $this->phone!=false && $this->ouvert!=false){
                                                            return view('livewire.counter', [
                ...
                ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',$this->selectedCommune)
                ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')->whereNotNull('rating')->whereNotNull('phone')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
                ->limit(1)->get()]);
                                                            }
                                                            else if ($this->website!=false && $this->rating==false && $this->phone!=false && $this->ouvert!=false){
                                                                return view('livewire.counter', [
                ...
                ->count(),'withrating'=>RentAgency::whereNotNull('rating')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')
                ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('rating')->whereNotNull('phone')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
                ->limit(1)->get()]);
                        } 
        ...
        if($this->website==false && $this->rating==false && $this->phone==false && $this->ouvert==false){
            ...
            ->whereNotNull('rating')->groupBy('rate')
            ->orderBy('count','desc')
            ->get(),'withwebsite'=>RentAgency::whereNotNull('website')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ...
            ->limit(1)->get()
                ...
                ->whereNotNull('rating')->groupBy('rate')
                ->orderBy('count','desc')
                ->get(),'withwebsite'=>RentAgency::whereNotNull('website')->where('commune_id',$this->selectedCommune)->orWhere('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withrating'=>RentAgency::whereNotNull('rating')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ...
            ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->orWhere('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('rating')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
            ->limit(1)->get()]);
                            }
                            else if ($this->website!=false && $this->rating==false && $this->phone!=false && $this->ouvert==false){
                                return view('livewire.counter', [
            ...
            ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->orWhere('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('phone')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
            ->limit(1)->get()]);
                                }
                                else if ($this->website!=false && $this->rating==false && $this->phone==false && $this->ouvert!=false){
                                    return view('livewire.counter', [
            ...
            ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->orWhere('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
            ->limit(1)->get()]);
                                    }
                                else if ($this->website==false && $this->rating!=false && $this->phone!=false && $this->ouvert==false){
                                    return view('livewire.counter', [
            ...
            ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->orWhere('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')->whereNotNull('rating')->whereNotNull('phone')->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
            ->limit(1)->get()]);
                                    }
                                    else if ($this->website==false && $this->rating!=false && $this->phone==false && $this->ouvert!=false){
                                        return view('livewire.counter', [
            ...
            ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->orWhere('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')->whereNotNull('rating')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
            ->limit(1)->get()]);
                                        }
                                        else if ($this->website==false && $this->rating==false && $this->phone!=false && $this->ouvert!=false){
                                            return view('livewire.counter', [
            ...
            ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->orWhere('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')->whereNotNull('phone')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
            ->limit(1)->get()]);
                                            }
                                            else if ($this->website!=false && $this->rating!=false && $this->phone!=false && $this->ouvert==false){
                                                return view('livewire.counter', [
            ...
            ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->orWhere('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('rating')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
            ->limit(1)->get()]);
                                                    }
                                                    else if ($this->website==false && $this->rating!=false && $this->phone!=false && $this->ouvert!=false){
                                                        return view('livewire.counter', [
            ...
            ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->orWhere('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')->whereNotNull('rating')->whereNotNull('phone')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
            ->limit(1)->get()]);
                                                        }
                                                        else if ($this->website!=false && $this->rating==false && $this->phone!=false && $this->ouvert!=false){
                                                            return view('livewire.counter', [
            ...
            ->count(),'withphone'=>RentAgency::whereNotNull('phone')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'withopenstate'=>RentAgency::where('open_state','Ouvert 24h/24')->where('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')
            ->count(),'total'=>RentAgency::where('commune_id',$this->selectedCommune)->orWhere('commune_id',Communes::select('id')->where('name',$this->selectedPosition)->pluck('id'))->where('title','like', '%'.trim($this->search).'%')->whereNotNull('website')->whereNotNull('phone')->where('open_state',$this->ouvert)->count(),'addresses'=>Communes::with('wilaya')->where('name','like', '%'.$this->searchPosition.'%')
            ->limit(1)->get()]);
                                                            }
                else{
                    return view('livewire.counter', [
...
public function likeService($agency_id,$agency_type)
    {
        
        if(Auth::user()->hasVerifiedEmail()){
        //$user_id=Auth::user()->id;
        $AlreadyLikedService=MyLikedService::where('user_id',Auth::user()->id)->where('agency_id',$agency_id)->where('agency_type',$agency_type)->first();
       if($AlreadyLikedService){
       dd('already liked');
       }
       else{
       ...
       // dd($this->liked);
        //$this->isSetClicked = true;
   /*     $this->dispatchBrowserEvent('swal', ['title' => 'Feedback Saved']);*/
    dd('your liked have stored successfuly');
