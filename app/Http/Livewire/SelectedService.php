  ...
  if(Auth::user()->hasVerifiedEmail()){
    if($this->agencyLikedId!=null and $this->agencyLikedType!=null )  {
           ...
           if($AlreadyLikedService){
               ...
               $AlreadyLikedService2=MyLikedService::where('user_id',Auth::user()->id)->where('agency_id',$this->agencyLikedId)->where('agency_type',$this->agencyLikedType)->where('liked','!=',$this->likeed)->first();
       ...
       /*     $this->dispatchBrowserEvent('swal', ['title' => 'Feedback Saved']);*/
        ...
        if($this->liked=="saved"){
            ...
            //$user_id=Auth::user()->id;
          $user_services=MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get();
 
        
      //  dd( MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get());
         //dd($data['token'][0]);
            //dd(MyService::select('agency_id')->where('user_id',Auth::user()->id));
        if($this->website==false && $this->rating==false && $this->phone==false){
       
        return view('livewire.selected-service', [
            'agencies' => AllServices::where(function($sub_query) {
                $sub_query->where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->latest();
        ...
        ->whereNotNull('rating')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->groupBy('rate')
        ->orderBy('count','desc')
        ->get(),'withwebsite'=>AllServices::whereNotNull('website')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withrating'=>AllServices::whereNotNull('rating')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withphone'=>AllServices::whereNotNull('phone')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count()
        ,'total'=>AllServices::where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->count(),]);
            ...
            return view('livewire.selected-service', [
                'agencies' => AllServices::where(function($sub_query) {
                    $sub_query->where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('website');
                })->orderBy($this->filter,'desc')->paginate(6)
            ,'ratings'=>AllServices::select(\DB::raw('(CASE WHEN rating BETWEEN 4.0 AND 5.0 THEN "best"
            WHEN rating BETWEEN 3.0 AND 4.0 THEN "good"
            WHEN rating BETWEEN 2.0 AND 3.0 THEN "medium"
            ...
            WHEN rating  BETWEEN 0 AND 1.0 THEN "verybad"
            ELSE "others" END)  AS rate'), \DB::raw('count(1) as count'))
            ->whereNotNull('rating')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->groupBy('rate')
            ->orderBy('count','desc')
            ->get(),'withwebsite'=>AllServices::whereNotNull('website')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withrating'=>AllServices::whereNotNull('rating')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withphone'=>AllServices::whereNotNull('phone')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>AllServices::where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('website')->count(),]);
            } else if ($this->website==false && $this->rating!=false && $this->phone==false ){
                return view('livewire.selected-service', [
                    'agencies' => AllServices::where(function($sub_query) {
                        $sub_query->where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('rating');
                    })->orderBy($this->filter,'desc')->paginate(6)
                ,'ratings'=>AllServices::select(\DB::raw('(CASE WHEN rating BETWEEN 4.0 AND 5.0 THEN "best"
                WHEN rating BETWEEN 3.0 AND 4.0 THEN "good"
                WHEN rating BETWEEN 2.0 AND 3.0 THEN "medium"
        ...
        ->count(),'withrating'=>AllServices::whereNotNull('rating')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withphone'=>AllServices::whereNotNull('phone')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>AllServices::where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('rating')->count(),]);
                }
                else if ($this->website==false && $this->rating==false && $this->phone!=false){
                    return view('livewire.selected-service', [
                        'agencies' => AllServices::where(function($sub_query) {
                            $sub_query->where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('phone');
                        })->orderBy($this->filter,'desc')->paginate(6)
                    ,'ratings'=>AllServices::select(\DB::raw('(CASE WHEN rating BETWEEN 4.0 AND 5.0 THEN "best"
                    WHEN rating BETWEEN 3.0 AND 4.0 THEN "good"
                    WHEN rating BETWEEN 2.0 AND 3.0 THEN "medium"
        ...
        ->count(),'withrating'=>AllServices::whereNotNull('rating')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withphone'=>AllServices::whereNotNull('phone')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>AllServices::where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('phone')->count(),]);
                    }
                 
                    else if ($this->website!=false && $this->rating!=false && $this->phone==false){
                        return view('livewire.selected-service', [
                            'agencies' => AllServices::where(function($sub_query) {
                                $sub_query->where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('website')->whereNotNull('rating');
                            })->orderBy($this->filter,'desc')->paginate(6)
                        ,'ratings'=>AllServices::select(\DB::raw('(CASE WHEN rating BETWEEN 4.0 AND 5.0 THEN "best"
                        WHEN rating BETWEEN 3.0 AND 4.0 THEN "good"
                        WHEN rating BETWEEN 2.0 AND 3.0 THEN "medium"
        ...
        ->count(),'withrating'=>AllServices::whereNotNull('rating')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withphone'=>AllServices::whereNotNull('phone')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>AllServices::where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('website')->whereNotNull('rating')->count(),]);
                        }
                        else if ($this->website!=false && $this->rating==false && $this->phone!=false){
                            return view('livewire.selected-service', [
                                'agencies' => AllServices::where(function($sub_query) {
                                    $sub_query->where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('website')->whereNotNull('phone');
                                })->orderBy($this->filter,'desc')->paginate(6)
                            ,'ratings'=>AllServices::select(\DB::raw('(CASE WHEN rating BETWEEN 4.0 AND 5.0 THEN "best"
                            WHEN rating BETWEEN 3.0 AND 4.0 THEN "good"
                            WHEN rating BETWEEN 2.0 AND 3.0 THEN "medium"
        ...
        ->count(),'withrating'=>AllServices::whereNotNull('rating')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withphone'=>AllServices::whereNotNull('phone')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>AllServices::where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('website')->whereNotNull('phone')->count(),]);
                            }
                           
                            else if ($this->website==false && $this->rating!=false && $this->phone!=false ){
                                return view('livewire.selected-service', [
                                    'agencies' => AllServices::where(function($sub_query) {
                                        $sub_query->where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('rating')->whereNotNull('phone');
                                    })->orderBy($this->filter,'desc')->paginate(6)
                                ,'ratings'=>AllServices::select(\DB::raw('(CASE WHEN rating BETWEEN 4.0 AND 5.0 THEN "best"
                                WHEN rating BETWEEN 3.0 AND 4.0 THEN "good"
                                WHEN rating BETWEEN 2.0 AND 3.0 THEN "medium"
        ...
        ->count(),'withrating'=>AllServices::whereNotNull('rating')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withphone'=>AllServices::whereNotNull('phone')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>AllServices::where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('rating')->whereNotNull('phone')->count(),]);
                                }
                                            ...
                                            return view('livewire.selected-service', [
                                                'agencies' => AllServices::where(function($sub_query) {
                                                    $sub_query->where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('website')->whereNotNull('rating')->whereNotNull('phone');
                                                })->orderBy($this->filter,'desc')->paginate(6)
                                            ,'ratings'=>AllServices::select(\DB::raw('(CASE WHEN rating BETWEEN 4.0 AND 5.0 THEN "best"
                                            WHEN rating BETWEEN 3.0 AND 4.0 THEN "good"
                                            WHEN rating BETWEEN 2.0 AND 3.0 THEN "medium"
        ...
        ->count(),'withrating'=>AllServices::whereNotNull('rating')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withphone'=>AllServices::whereNotNull('phone')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>AllServices::where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('website')->whereNotNull('rating')->whereNotNull('phone')->count(),]);
                                            }
                ...
                return view('livewire.selected-service', [
                    'agencies' => AllServices::where(function($sub_query) {
                        $sub_query->where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('website')->whereNotNull('rating')->whereNotNull('phone')->where('open_state',$this->ouvert);
                    })->orderBy($this->filter,'desc')->paginate(6)
                ,'ratings'=>AllServices::select(\DB::raw('(CASE WHEN rating BETWEEN 4.0 AND 5.0 THEN "best"
                WHEN rating BETWEEN 3.0 AND 4.0 THEN "good"
                WHEN rating BETWEEN 2.0 AND 3.0 THEN "medium"
        ...
        ->count(),'withrating'=>AllServices::whereNotNull('rating')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'withphone'=>AllServices::whereNotNull('phone')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->where('title','like', '%'.trim($this->search).'%')
        ->count(),'total'=>AllServices::where('title','like', '%'.trim($this->search).'%')->whereIn('token',MyService::select('token')->where('user_id',Auth::user()->id)->latest()->get())->where('type',$this->type)->whereNotNull('website')->whereNotNull('rating')->whereNotNull('phone')->where('open_state',$this->ouvert)->count(),
        ]); 
                } 
