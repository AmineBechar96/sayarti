...
$(document).ready(function () {
    ...
    var lineChartOptions = {
      ...
      series: [{
        name: "Desktops",
        data: [186.90, 186.11, 190, 194, 187, 182, 183, 191, 203],
      }],
      title: {
      ...
      xaxis: {
        categories: ['2021-07-05', '2021-07-08', '2021-07-09', '2021-07-10', '2021-07-11', '2021-07-12', '2021-07-13', '2021-07-14', '2021-07-18'],
      },
      yaxis: {
        tickAmount: 5,
  ...
  // Line Chart
    ...
    var lineChartOptions2 = {
      ...
      series: [{
        name: "Desktops",
        data: [2382, 1219, 581, 613, 766, 759, 768, 765, 1286],
      }],
      title: {
    ...
    var barChartOptions = {
      ...
      series: [{name: 'Pourcentage(%)',
        data: [3.40, 3.07, 2.77, 2.19, 2.19, 1.68, 1.55, 1.55, 1.43, 1.4]
      }],
      xaxis: {
        categories: ['Sandero Stepway', 'Clio 4', 'Symbol', 'Golf 7', 'Kangoo', '208 Allure', 'Accent GLS', 'Kangoo Privilège', 'Clio Campus', 'Leon FR'],
        tickAmount: 5
      },
      yaxis: {
        opposite: yaxis_opposite
    ...
    var barChartOptions2 = {
      ...
      series: [{name: 'Prix Moyen (millions DZD)',
        data: [885, 841, 811, 800, 786, 811, 800, 786, 730, 720]
      }],
      xaxis: {
        categories:['Octavia VRS', 'Macan', 'New Tiguan', 'Touran Rline', 'A3 Cabriolet','Caddy New','Benz GLC' ,'Macan 3.0' ,'Golf Plus' ,'A4 Business' ],      
        tickAmount: 5
      },
      yaxis: {
        opposite: yaxis_opposite
    ...
    var barChartOptions3 = {
      ...
      series: [{name: 'pct de Nombre de Voitures (%)',
        data: [19.29, 15.87, 15.74, 11.87, 10.73, 6.91, 4.34, 4.32,2.22, 2.05]
      }],
      xaxis: {
        categories:['1.6L', '2L', '1.5L', '1.4L', '1.2L','1.9L','1L' ,'1.1L' ,'2.5L' ,'1.3L' ],      
        tickAmount: 5
      },
      yaxis: {
        opposite: yaxis_opposite
    ...
    var barChartOptions4 = {
      ...
      series: [{name: 'pct de Nombre de Voitures (%)',
        data: [37.70, 13.5, 13.4, 9.76, 5.11, 3.36, 3.06, 2.86]
      }],
      xaxis: {
        categories:['ess', 'dci', 'tdi', 'hdi', 'd','mpi','crdi' ,'vti'],      
        tickAmount: 5
      },
      yaxis: {
        opposite: yaxis_opposite
    ...
    var barChart = new ApexCharts(
      document.querySelector("#bar-chart5"),
      barChartOptions
    );
    barChart.render();
  
    var barChart2 = new ApexCharts(
      document.querySelector("#bar-chart6"),
      barChartOptions2
    );
    barChart2.render();
  
    var barChart3 = new ApexCharts(
      document.querySelector("#bar-chart7"),
      barChartOptions3
    );
    barChart3.render();
  
    var barChart4 = new ApexCharts(
      document.querySelector("#bar-chart8"),
      barChartOptions4
    );
    barChart4.render();
    ...
    var mixedChartOptions = {
      ...
      series: [{
        ...
        type: 'column',
        data: [3983, 2397, 1670, 928, 329,150]
      }],
      fill: {
        opacity: [0.85, 0.25, 1],
        gradient: {
      ...
      labels: ['61-90', '91-120', '151-180', '121-150', '30-60', '181 - Plus'],
      markers: {
        size: 0
      },
      legend: {
    ...
    var mixedChartOptions2 = {
      ...
      series: [{
        ...
        type: 'area',
        data: [4.19, 3.95, 6.61, 10.08, 10.77,8.39,6.01,4.04,4.29,6.02,8.23,1.26,4.62]
      }],
      fill: {
        opacity: [0.85, 0.25, 1],
        gradient: {
    ...
    var mixedChart2 = new ApexCharts(
      document.querySelector("#mixed-chart2"),
      mixedChartOptions2
    );
    mixedChart2.render();
    ...
    var pieChartOptions = {
      ...
      colors: themeColors,
      labels: ['Diesel', 'Essence', 'GPL'],
      series: [51.13, 40.65, 8.20],
      legend: {
        itemMargin: {
          horizontal: 2
        },
    ...
    var donutChartOptions = {
      ...
      colors: themeColors,
      labels: ['Alger', 'Oran', 'Blida', 'Sétif','Boumerdes','Constantine','Batna','Tizi','Tlemcen','Bejaia','Bouira'],
      series: [26,7.16, 5.44, 4.92, 3.54,3.37,3.26,2.44,2.34,2.31,2.24],
      legend: {
        itemMargin: {
          horizontal: 2
        },
    ...
    var donutChartOptions2 = {
      ...
      colors: themeColors,
      labels: ['Citadine', 'Berline', 'Moyenne berline', 'Mini citadine','Commerciale','Tout terrain - SUV','Break - Familiale','Pickup'],
      series: [31.65,20.02, 13.33, 9.37, 8.69,7.51,4.11,2.22],
      legend: {
        itemMargin: {
          horizontal: 2
        },
