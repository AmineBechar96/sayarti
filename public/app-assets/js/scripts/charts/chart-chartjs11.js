...
$(window).on("load", function () {
    ...
    // Chart Data
    var barchartData = {
      labels: ["Renault", "Peugeot", "Volkswagen", "Hyundai", "Seat"],
      datasets: [{
        label: "Pourcentage (%)",
        data: [30, 25, 17, 14, 10],
    ...
    var barchartData2 = {
      labels: ["Porsche", "Land", "Land", "BMW", "Mercedes"],
      datasets: [{
        label: "Prix Moyens (millions)",
        data: [806, 387, 386, 374, 314],
        backgroundColor: themeColors,
        borderColor: "transparent"
      }]
    };
    ...
    var horizontalchartData = {
      labels: ["Blanc", "Noir", "Gris Argent", "Gris", "Gris Souris","Gris Manitoba"],
      datasets: [{
        label: "Nombre Voitures",
        data: [3234, 1431, 1421, 1074, 706,263],
        backgroundColor: themeColors,
        borderColor: "transparent"
      }]
    };
