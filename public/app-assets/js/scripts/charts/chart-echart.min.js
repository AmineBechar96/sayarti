$(window).on('load', function() {
    var e = '#4ea397',
        a = echarts.init(document.getElementById('bar-chart'));
    function t() {
    ...
    var i = {
        ...
        dataset: {
            source: [
                ...
                ['Milk Tea', t(), t(), t()],
                ['Cheese Cocoa', t(), t(), t()],
                ['Walnut Brownie', t(), t(), t()]
            ]
        },
        xAxis: { type: 'category', splitLine: { show: !0 } },
        yAxis: {},
        series: [
            { type: 'bar', itemStyle: { color: e } },
            { type: 'bar', itemStyle: { color: '#22c3aa' } },
            { type: 'bar', itemStyle: { color: '#7bd9a5' } }
        ]
    };
    a.setOption(i);
    var n = echarts.init(document.getElementById('line-chart')),
        r = {
            visualMap: [
                {
                    show: !(d = [
    ...
    var o = echarts.init(document.getElementById('scatter-chart')),
        s = {
    ...
    o.setOption(s);
    for (
        var l = echarts.init(document.getElementById('polar-chart')),
            d = [],
            c = 0;
        c <= 360;
        c++
