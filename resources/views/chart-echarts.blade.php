...
<head>
    ...
    <title>Echarts - Vuexy - Bootstrap HTML admin template</title>
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active" data-menu=""><a class="dropdown-item" href="chart-echarts.html"
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Echarts</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Echarts
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                <div class="row">
                    <div class="col-12">
                        <p>ECharts component for visualization library for browser. Read full documnetation <a
                                href="https://github.com/apache/incubator-echarts" target="_blank">here</a></p>
                    </div>
                </div>
                <!-- Bar Chart -->
                <div class="row">
