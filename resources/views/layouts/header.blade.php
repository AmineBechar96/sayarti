    ...
    <div class="navbar-header d-xl-block d-none">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item"><a class="navbar" href="../../../html/ltr/horizontal-menu-template/index.html">
                    <div class="brand-logo"><img src="../../../app-assets/images/logo/ss.png" height="45" width="120"
                            alt=""></div>
                </a></li>
        </ul>
    </div>
            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link"
                            ...
                            aria-expanded="false"><i class="flag-icon flag-icon-fr"></i><span
                                class="selected-language">French</span></a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag"><a class="dropdown-item" href="#"
                                ...
                                French</a><a class="dropdown-item" href="#" data-language="ar"><i
                                    class="flag-icon flag-icon-ar"></i>
                                Arabic</a><a class="dropdown-item" href="#" data-language="ar"><i
