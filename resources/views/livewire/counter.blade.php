                    ...
                    <div class="card-content" id="prod1">
                        ...
                        <div class="item-options text-center">
                            ...
                            <div class="cart">
                                ...
                                </span> <a href="#" data-title="{{$agency->title}}" data-toggle="modal"
                                ...
                                <span class="add-to-cart"
                                    wire:click="store({{$agency->ID}},'{{$agency->type}}')">Enregistrer
                                </span>
...
if($('.wishlist').children().hasClass("fa-heart-o")){
    
    var type= $('#wishlist').data("type")
    var id= $('#wishlist').data("agency_id");
    console.log(id);
    @this.set('liked',true);
