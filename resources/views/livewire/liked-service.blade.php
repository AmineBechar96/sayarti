                ...
                <div class="card ecommerce-card">
                    <div class="card-content" id="prod1">
                        ...
                        <div class="item-options text-center">
                            ...
                            <div class="wishlistt" wire:click="dislike({{$agency->agency_ID}},'{{$agency->type}}')">

                                <span> <i class="fa fa-heart text-danger" wire:ignore.self></i>
                                    <span>J'ADORS Pas</span></span>
                            </div>
                            ...
                            <div class="cart">
                                ...
                                <span class="add-to-cart"
                                    wire:click="store({{$agency->agency_ID}},'{{$agency->type}}')">Enregistrer
                                </span>
                            ...
                            <div class="card-content">
                                <div class="card-body text-center">
                                    ...
                                    <h1 class="font-large-2 my-1">Oups -No Content
                                        Found!</h1>
                                    <p class="p-2">
                                        Vous n'avez aimé aucun service, vous pouvez ajouter un service en cliquant
