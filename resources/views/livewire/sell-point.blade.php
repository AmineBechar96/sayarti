                ...
                <div class="card ecommerce-card">
                    <div class="card-content" id="prod1">
                        <div class="item-img text-center">
                            ...
                            @else
                            <a href="{{$agency->type}}/agency-details/{{$agency->ID}}"> <img class="img-fluid"
                                    src="../../../app-assets/images/brands/img.jpg" alt="img-placeholder"></a>
                            @endif
                    ...
                    <div class="card-body">
                        ...
                        <div id="product-categories">
                            ...
                            <ul class="list-unstyled categories-list">
                                ...
                                <li>
                                    <span class="vs-radio-con vs-radio-primary py-25">
                                        <input type="radio" name="filter" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span class="sidebar-close-icon">
                        ...
                        <div class="chat-fixed-search">
                            <h3 class="primary p-1 mb-0">Marques</h3>
                            <div class="d-flex align-items-center">

                                <fieldset class="form-group position-relative has-icon-left mx-1 my-0 w-100">
                                    <input type="text" class="form-control round" name="searchModel"
                                        wire:model="searchModel" id="searchModel"
                        ...
                        <div id="users-list" class="chat-user-list list-group position-relative mt-2">
                            ...
                            <ul class="chat-users-list-wrapper media-list">
                                ...
                                <li class="list-group-item text-center mr-3">

                                    <img class="img-fluid cursor-pointer" id="mod"
                                        src="../../../app-assets/images/brands/{{strtolower($model->Maison)}}.png"
                                        alt="{{$model->Maison}}">
    ...
    $(document).ready(function () {
                    ...
                    $('#selectedCommune').on('change', function (e) {
                        ...
                        $('#mod').on('click', function (e) {
                           var selectedModel= $('#mod').attr('alt');
                           
                           // selectedModel='["'+selectedModel+'",'+'"'+selectedModel+'"]'; 
                            console.log(selectedModel);
                            @this.set('modell',selectedModel);
